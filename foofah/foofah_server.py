...
class MainPage(object):
    ...
    def astar(self):
        ...
        start = timer()
        final_node, open_nodes, closed_nodes = foofahService.a_star_search(raw_data, target, add_ops(), 0, 100, batch=True,
                                                                    epsilon=1)
        end = timer()

        path = foofahService.reconstruct_path(final_node)
