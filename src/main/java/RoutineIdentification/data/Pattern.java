...
public class Pattern implements Comparable<Pattern>{
    ...
    public Integer getAbsoluteSupport(){ return this.absSupport; }

    public int getLength(){ return this.length; }

    public void setRelativeSupport(double support){ this.relSupport = support; }

    public void setAbsoluteSupport(Integer support){ this.absSupport = support; }
